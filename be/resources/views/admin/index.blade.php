        ...
        <form action="{{ route('admin.index') }}" method="GET">
            ...
            <div class="d-flex mb-4">
                ...
                <label>Admin Role:</label>
                    <div class="d-flex align-middle">
                        <div class="form-check m-2">
                            <input class="form-check-input" type="radio" name="admin_role" id="admin_role_all" value=""{{ request('admin_role') == '' ? 'checked' : '' }}>
                            <label class="form-check-label" for="admin_role_all"><h6>All</h6></label>
                        </div>
                        <div class="form-check m-2">
                            <input class="form-check-input" type="radio" name="admin_role" id="admin" value="1" {{ request('admin_role') == '1' ? 'checked' : '' }}>
                            <label class="form-check-label" for="admin"><h6>Admin</h6></label>
                        </div>
                        <div class="form-check m-2">
                            <input class="form-check-input" type="radio" name="admin_role" id="leadadmin" value="2" {{ request('admin_role') == '2' ? 'checked' : '' }}>
                            <label class="form-check-label" for="leadadmin"><h6>LeadAdmin</h6></label>
                        </div>
                    </div>
                </div>
                <div class="flex-fill">
...
<script>
    ...
    function getUser(userID){
            ...
            editForm.action = "{{ route('admin.editHandle', ['id' => ':userID']) }}".replace(':userID', userID);
            $j.ajax({
