 ...
 <div class="modal fade" id="createUser" tabindex="-1" style="display: none;" aria-hidden="true">
     <div class="modal-dialog " role="document">
         <div class="modal-content">
            ...
            <form action="{{ route('user.createHandle' )}}" method="POST">
                @csrf
             <div class="modal-body">
                 ...
                 <div class="row">
                     <div class="col mb-3">
                         ...
                         <div class="input-group">
                             <input type="password" id="createPassword" name="re_password" class="form-control" placeholder="Re-Enter password">
                         </div>
                     </div>
                 </div>
                 <div class="row">
                ...
                <input type="file" name="createInputUser" class="form-control d-none" id="createInputUser" onchange="previewUser('create')">
